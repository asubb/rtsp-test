...
class RtspRecordControllerHandler(
    ...
    fun attachTo(pipeline: ChannelPipeline) {
        pipeline.addLast(rtspRecordReceiverHandler)
                .addLast(RtspDecoder())
    ...
    override fun channelRead(ctx: ChannelHandlerContext, msg: Any) {
        ...
        channels.getValue(channelId).accessedLastTime = System.currentTimeMillis()
        ...
        if (msg is FullHttpRequest) {
            ...
            when (msg.method()) {
                ...
                RtspMethods.ANNOUNCE -> {
                    ...
                    handleAnnounce(msgContent, channelId)
                }
                RtspMethods.SETUP -> {
    ...
    private fun handleAnnounce(msgContent: ByteBuf, channelId: String) {
